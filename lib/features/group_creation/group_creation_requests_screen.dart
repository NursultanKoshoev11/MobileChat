...
class GroupCreationRequestsScreen extends StatefulWidget {
  ...
  @override
  State<GroupCreationRequestsScreen> createState() =>
      _GroupCreationRequestsScreenState();
}
                    ...
                    KoomCard(
                      ...
                      child: KoomEmptyState(
                        ...
                        title: text.isKy
                            ...
                            : 'Пока нет заявок',
                        message: text.isKy
                            ? 'Расмий топ керек болсо, өтүнүч жөнөтүңүз.'
                            : 'Отправьте заявку, если вам нужна официальная группа.',
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  if (index == 0) {
                    return Padding(
                      ...
                      child: KoomSectionTitle(
                        title: text.myRequests,
                        subtitle: text.isKy
                            ? '${requests.length} өтүнүч'
                  ...
                  return GroupCreationRequestCard(
                    request: request,
                    number: index,
                    onTap: request.status == 'needs_more_info'
...
class CreateGroupRequestSheet extends StatefulWidget {
  ...
  @override
  State<CreateGroupRequestSheet> createState() =>
      _CreateGroupRequestSheetState();
}
...
class _CreateGroupRequestSheetState extends State<CreateGroupRequestSheet> {
  ...
  void initState() {
    ...
    applicant.text = initial?.applicantName.isNotEmpty == true
    ...
    officialPhone.text = initial?.officialPhone.isNotEmpty == true
        ? initial!.officialPhone
        : (widget.user.mobile ?? '');

...
class AppText {
  ...
  String get copyInviteCode => isKy ? 'Чакыруу кодун көчүрүү' : 'Скопировать код приглашения';
  String get inviteCodeCopied => isKy ? 'Чакыруу коду көчүрүлдү.' : 'Код приглашения скопирован.';
  ...
  String get displayNameRequiredForNewAccount => isKy ? 'Жаңы аккаунт үчүн аты-жөнүңүздү жазыңыз' : 'Для нового аккаунта нужно указать имя';
  String get existingAccountHint => isKy ? 'Аккаунт табылды. Кодду гана жазыңыз.' : 'Аккаунт найден. Введите только код.';
  ...
  String get discussionWithComments => isKy ? 'Комментарий менен талкуу' : 'Обсуждение с комментариями';
  ...
  String get noCommentsYet => isKy ? 'Комментарий жок.' : 'Комментариев пока нет.';
  String get readOnlyPost => isKy ? 'Бул жарыя окуу үчүн гана.' : 'Эта публикация только для чтения.';
  String get voteOnlyPost => isKy ? 'Бул жарыяда добуш гана берилет. Комментарий өчүрүлгөн.' : 'В этой публикации доступно только голосование. Комментарии отключены.';
